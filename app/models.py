...
class MajorConcentration(models.Model):
    name = models.CharField(max_length=50, default='', verbose_name="Konsentrasi Jurusan")
...
class Subject(models.Model):
    ...
    major = models.ManyToManyField(Major, null=True, blank=True, verbose_name="Jurusan")
    concentration = models.ManyToManyField(
        MajorConcentration, null=True, blank=True, verbose_name="Konsentrasi"
    )
